...
- Dashboard simplification V1.5 (2026-07-16 15:38): at the user's request, the “生活恢复” dashboard item was removed completely from navigation, HTML, frontend rendering/localStorage integration, API payload, `config.json`, CSS, and automated-test expectations. This is a presentation/module deletion only: `交易生活执行手册.md`, the current recovery-phase behavioral gate, and the permission-card trading restrictions remain active project rules.
